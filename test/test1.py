...
beam = SteelBeam(nodes, considerSelfWeight = True, depthClass = 12,
weightClass = 14, eleSpacing = 0.5 * units.inch, outputPDF = True,
name = 'Test1', level = 2, outputPath = 'output_reports/test1')
