...
\begin{figure}[H]
\begin{center}
\input{output_reports/test4/Test4_loadDiagram.pgf}
\end{center}
\vspace{-18pt}
...
LC 2 & 1.4D + 0.5L1 & ASCE7-16 \S2.3.6 (LC 6)\\
LC 3 & 1.2D + 1.0L0 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 4 & 1.2D + 1.6L1 & ASCE7-16 \S2.3.1 (LC 2)\\
LC 5 & 1.4D + 0.5L0 & ASCE7-16 \S2.3.6 (LC 6)\\
LC 6 & 1.4D + 0.5L0 + 0.5L1 & ASCE7-16 \S2.3.6 (LC 6)\\
LC 7 & 1.4D & ASCE7-16 \S2.3.1 (LC 1)\\
LC 8 & 1.2D & ASCE7-16 \S2.3.1 (LC 3)\\
LC 9 & 1.2D + 1.0L0 + 1.0L1 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 10 & 1.2D + 1.6L0 & ASCE7-16 \S2.3.1 (LC 2)\\
LC 11 & 0.7D & ASCE7-16 \S2.3.6 (LC 7)\\
LC 12 & 1.2D + 1.0L1 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 13 & 1.2D + 1.6L0 + 1.6L1 & ASCE7-16 \S2.3.1 (LC 2)\\
\hline
\end{tabular}
\end{table}
\begin{table}[H]
...
LC 2 & 1.14D & ASCE7-16 \S2.4.5 (LC 8)\\
LC 3 & 1.0D + 0.75L0 & ASCE7-16 \S2.4.1 (LC 4)\\
LC 4 & 1.1D + 0.75L0 & ASCE7-16 \S2.4.5 (LC 8)\\
LC 5 & 1.0D + 0.75L1 & ASCE7-16 \S2.4.1 (LC 4)\\
LC 6 & 1.1D + 0.75L1 & ASCE7-16 \S2.4.5 (LC 8)\\
LC 7 & 1.0L0 + 1.0L1 & L only deflection check\\
LC 8 & 1.0D + 1.0L0 & ASCE7-16 \S2.4.1 (LC 2)\\
LC 9 & 1.0L0 & L only deflection check\\
LC 10 & 1.0D + 1.0L0 + 1.0L1 & ASCE7-16 \S2.4.1 (LC 2)\\
LC 11 & 0.6D & ASCE7-16 \S2.4.1 (LC 7)\\
LC 12 & 1.0D + 1.0L1 & ASCE7-16 \S2.4.1 (LC 2)\\
LC 13 & 1.1D + 0.75L0 + 0.75L1 & ASCE7-16 \S2.4.5 (LC 8)\\
LC 14 & 0.4D & ASCE7-16 \S2.4.5 (LC 9)\\
LC 15 & 1.0D + 0.75L0 + 0.75L1 & ASCE7-16 \S2.4.1 (LC 4)\\
LC 16 & 1.0L1 & L only deflection check\\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test4/Test4_moment.pgf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test4/Test4_Cb.pgf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test4/Test4_shear.pgf}
\end{center}
...
\begin{flalign*}
\frac{h}{t_w} = \frac{8.9 {\color{darkBlue}{\mathbf{ \; in}}}}{0.24 {\color{darkBlue}{\mathbf{ \; in}}}} = \mathbf{37.0 } <= 2.24\sqrt{\frac{E}{F_y}} = 2.24\sqrt{\frac{29000 {\color{darkBlue}{\mathbf{ \; ksi}}}}{50 {\color{darkBlue}{\mathbf{ \; ksi}}}}} = \mathbf{53.9 } \rightarrow C_{v1} = \mathbf{1.0}
\end{flalign*}
...
\begin{flalign*}
\phi_v V_n = 0.6\cdot F_y \cdot A_w \cdot C_{v1}  = 0.6\cdot 50 {\color{darkBlue}{\mathbf{ \; ksi}}} \cdot 2.448 {\color{darkBlue}{\mathbf{ \; {\color{darkBlue}{\mathbf{ \; in}}}^{2}}}} \cdot C_{v1}  = \mathbf{73.4 {\color{darkBlue}{\mathbf{ \; kip}}}}
\end{flalign*}
\vspace{-26pt}
{\setlength{\mathindent}{0cm}
\begin{flalign*}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test4/Test4_defl.pgf}
\end{center}
