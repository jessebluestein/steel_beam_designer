...
\begin{figure}[H]
\begin{center}
\input{output_reports/test2/Test2_loadDiagram.pgf}
\end{center}
\vspace{-18pt}
...
LC 2 & 0.7D + -2.5E & ASCE7-16 \S2.3.6 (LC 7)\\
LC 3 & 1.2D + 1.0L0 + 0.5L\textsubscriptr0 & ASCE7-16 \S2.3.1 (LC 4)\\
LC 4 & 1.4D & ASCE7-16 \S2.3.1 (LC 1)\\
LC 5 & 1.2D & ASCE7-16 \S2.3.1 (LC 3)\\
LC 6 & 0.9D & ASCE7-16 \S2.3.1 (LC 5)\\
LC 7 & 1.2D + 1.6L\textsubscriptr0 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 8 & 1.4D + 2.5E + 0.5L0 & ASCE7-16 \S2.3.6 (LC 6)\\
LC 9 & 1.2D + 1.0L0 + 1.6L\textsubscriptr0 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 10 & 0.7D + 2.5E & ASCE7-16 \S2.3.6 (LC 7)\\
LC 11 & 1.2D + 1.6L0 + 0.5L\textsubscriptr0 & ASCE7-16 \S2.3.1 (LC 2)\\
LC 12 & 1.2D + 1.6L0 & ASCE7-16 \S2.3.1 (LC 2)\\
LC 13 & 1.2D + 1.0L0 & ASCE7-16 \S2.3.1 (LC 3)\\
\hline
\end{tabular}
\end{table}
\begin{table}[H]
...
Load Combo & Loads and Factors & Reference\\
\hline
LC 1 & 1.1D + -1.31E + 0.75L0 & ASCE7-16 \S2.4.5 (LC 8)\\
LC 2 & 0.4D + -1.75E & ASCE7-16 \S2.4.5 (LC 9)\\
LC 3 & 0.6D & ASCE7-16 \S2.4.1 (LC 7)\\
LC 4 & 1.14D + 1.75E & ASCE7-16 \S2.4.5 (LC 8)\\
LC 5 & 1.0D & ASCE7-16 \S2.4.1 (LC 1)\\
LC 6 & 1.0D + 1.0L0 & ASCE7-16 \S2.4.1 (LC 2)\\
LC 7 & 1.0D + 1.0L\textsubscriptr0 & ASCE7-16 \S2.4.1 (LC 3)\\
LC 8 & 1.0D + 0.75L0 + 0.75L\textsubscriptr0 & ASCE7-16 \S2.4.1 (LC 4)\\
LC 9 & 1.0D + 0.75L0 & ASCE7-16 \S2.4.1 (LC 4)\\
LC 10 & 0.4D + 1.75E & ASCE7-16 \S2.4.5 (LC 9)\\
LC 11 & 1.1D + 1.31E + 0.75L0 & ASCE7-16 \S2.4.5 (LC 8)\\
LC 12 & 1.14D + -1.75E & ASCE7-16 \S2.4.5 (LC 8)\\
LC 13 & 1.0L0 & L only deflection check\\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test2/Test2_moment.pgf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test2/Test2_Cb.pgf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test2/Test2_shear.pgf}
\end{center}
...
\begin{flalign*}
\frac{h}{t_w} = \frac{11.4 {\color{darkBlue}{\mathbf{ \; in}}}}{0.645 {\color{darkBlue}{\mathbf{ \; in}}}} = \mathbf{17.73643410852713 } <= 2.24\sqrt{\frac{E}{F_y}} = 2.24\sqrt{\frac{29000 {\color{darkBlue}{\mathbf{ \; ksi}}}}{50 {\color{darkBlue}{\mathbf{ \; ksi}}}}} = \mathbf{53.9 } \rightarrow C_{v1} = \mathbf{1.0}
\end{flalign*}
\textphi\textsubscript{v}, the resistance factor for shear, is calculated per AISC/ANSI 360-16 {\S}G2.1.a as follows:
\begin{flalign*}
\frac{h}{t_w} = \frac{11.4 {\color{darkBlue}{\mathbf{ \; in}}}}{0.645 {\color{darkBlue}{\mathbf{ \; in}}}} = \mathbf{17.73643410852713 } <= 2.24\cdot \sqrt{\frac{E}{F_y}} = 2.24\cdot \sqrt{\frac{29000 {\color{darkBlue}{\mathbf{ \; ksi}}}}{50 {\color{darkBlue}{\mathbf{ \; ksi}}}}} = \mathbf{53.9} \rightarrow \phi_v = \mathbf{1.0}
\end{flalign*}
\textphi\textsubscript{v}V\textsubscript{n}, the design shear strength, is calculated per AISC/ANSI 360-16 Eq. G2-1 as follows:
\begin{flalign*}
\phi_v V_n = 0.6\cdot F_y \cdot A_w \cdot C_{v1}  = 0.6\cdot 50 {\color{darkBlue}{\mathbf{ \; ksi}}} \cdot 9.4815 {\color{darkBlue}{\mathbf{ \; {\color{darkBlue}{\mathbf{ \; in}}}^{2}}}} \cdot C_{v1}  = \mathbf{284.4 {\color{darkBlue}{\mathbf{ \; kip}}}}
\end{flalign*}
\vspace{-26pt}
{\setlength{\mathindent}{0cm}
\begin{flalign*}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test2/Test2_defl.pgf}
\end{center}
