...
\begin{figure}[H]
\begin{center}
\input{output_reports/test1/Test1_loadDiagram.pgf}
\end{center}
\vspace{-18pt}
...
LC 3 & 1.2D + 1.6L0 & ASCE7-16 \S2.3.1 (LC 2)\\
LC 4 & 1.2D & ASCE7-16 \S2.3.1 (LC 3)\\
LC 5 & 1.2D + 1.0L0 & ASCE7-16 \S2.3.1 (LC 3)\\
...
LC 4 & 0.6D & ASCE7-16 \S2.4.1 (LC 7)\\
LC 5 & 1.0D + 0.75L0 & ASCE7-16 \S2.4.1 (LC 4)\\
LC 6 & 0.4D & ASCE7-16 \S2.4.5 (LC 9)\\
LC 7 & 1.1D + 0.75L0 & ASCE7-16 \S2.4.5 (LC 8)\\
LC 8 & 1.14D & ASCE7-16 \S2.4.5 (LC 8)\\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test1/Test1_moment.pgf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test1/Test1_Cb.pgf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test1/Test1_shear.pgf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test1/Test1_defl.pgf}
\end{center}
