...
\textbf{Date:} & {2021-03-28} & \textbf{Page:} & \thepage\\
\end{tabular}}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test3/Test3_loadDiagram.pgf}
\end{center}
\vspace{-18pt}
...
\hline
LC 1 & 1.2D + 1.6L1 + 0.5L\textsubscriptr1 & ASCE7-16 \S2.3.1 (LC 2)\\
LC 2 & 1.2D + 1.0L0 + 1.6L\textsubscriptr0 + 1.0L1 + 1.6L\textsubscriptr1 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 3 & 1.4D & ASCE7-16 \S2.3.1 (LC 1)\\
LC 4 & 1.2D + 1.0L0 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 5 & 1.2D + 1.6L0 + 0.5L\textsubscriptr0 + 1.6L1 + 0.5L\textsubscriptr1 & ASCE7-16 \S2.3.1 (LC 2)\\
LC 6 & 1.2D + 1.6L0 & ASCE7-16 \S2.3.1 (LC 2)\\
LC 7 & 1.4D + 2.5E + 0.5L1 & ASCE7-16 \S2.3.6 (LC 6)\\
LC 8 & 1.2D + 1.0L0 + 1.6L\textsubscriptr0 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 9 & 1.4D + -2.5E + 0.5L0 + 0.5L1 & ASCE7-16 \S2.3.6 (LC 6)\\
LC 10 & 1.2D + 1.6L0 + 1.6L1 & ASCE7-16 \S2.3.1 (LC 2)\\
LC 11 & 1.2D + 1.6L1 & ASCE7-16 \S2.3.1 (LC 2)\\
LC 12 & 1.4D + 2.5E + 0.5L0 & ASCE7-16 \S2.3.6 (LC 6)\\
LC 13 & 1.4D + -2.5E + 0.5L1 & ASCE7-16 \S2.3.6 (LC 6)\\
LC 14 & 1.4D + 2.5E + 0.5L0 + 0.5L1 & ASCE7-16 \S2.3.6 (LC 6)\\
LC 15 & 1.2D + 1.0L0 + 0.5L\textsubscriptr0 + 1.0L1 + 0.5L\textsubscriptr1 & ASCE7-16 \S2.3.1 (LC 4)\\
LC 16 & 1.2D + 1.0L0 + 1.0L1 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 17 & 1.2D & ASCE7-16 \S2.3.1 (LC 3)\\
LC 18 & 1.2D + 1.0L1 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 19 & 1.2D + 1.6L\textsubscriptr1 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 20 & 1.2D + 1.0L1 + 1.6L\textsubscriptr1 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 21 & 1.2D + 1.6L0 + 0.5L\textsubscriptr0 & ASCE7-16 \S2.3.1 (LC 2)\\
LC 22 & 0.9D & ASCE7-16 \S2.3.1 (LC 5)\\
LC 23 & 1.2D + 1.6L\textsubscriptr0 & ASCE7-16 \S2.3.1 (LC 3)\\
LC 24 & 0.7D + 2.5E & ASCE7-16 \S2.3.6 (LC 7)\\
LC 25 & 1.2D + 1.0L0 + 0.5L\textsubscriptr0 & ASCE7-16 \S2.3.1 (LC 4)\\
LC 26 & 1.2D + 1.0L1 + 0.5L\textsubscriptr1 & ASCE7-16 \S2.3.1 (LC 4)\\
LC 27 & 1.4D + -2.5E + 0.5L0 & ASCE7-16 \S2.3.6 (LC 6)\\
LC 28 & 0.7D + -2.5E & ASCE7-16 \S2.3.6 (LC 7)\\
LC 29 & 1.2D + 1.6L\textsubscriptr0 + 1.6L\textsubscriptr1 & ASCE7-16 \S2.3.1 (LC 3)\\
\hline
\end{tabular}
\end{table}
\begin{table}[H]
...
Load Combo & Loads and Factors & Reference\\
\hline
LC 1 & 1.0D + 1.0L\textsubscriptr1 & ASCE7-16 \S2.4.1 (LC 3)\\
LC 2 & 1.0D + 0.75L0 + 0.75L\textsubscriptr0 & ASCE7-16 \S2.4.1 (LC 4)\\
LC 3 & 1.1D + 1.31E + 0.75L1 & ASCE7-16 \S2.4.5 (LC 8)\\
LC 4 & 0.4D + -1.75E & ASCE7-16 \S2.4.5 (LC 9)\\
LC 5 & 1.0L1 & L only deflection check\\
LC 6 & 1.14D + -1.75E & ASCE7-16 \S2.4.5 (LC 8)\\
LC 7 & 1.0D + 0.75L0 + 0.75L1 & ASCE7-16 \S2.4.1 (LC 4)\\
LC 8 & 1.0D + 1.0L\textsubscriptr0 + 1.0L\textsubscriptr1 & ASCE7-16 \S2.4.1 (LC 3)\\
LC 9 & 1.0D + 1.0L\textsubscriptr0 & ASCE7-16 \S2.4.1 (LC 3)\\
LC 10 & 1.1D + -1.31E + 0.75L0 + 0.75L1 & ASCE7-16 \S2.4.5 (LC 8)\\
LC 11 & 1.0L0 & L only deflection check\\
LC 12 & 1.0D + 0.75L1 & ASCE7-16 \S2.4.1 (LC 4)\\
LC 13 & 1.0D + 1.0L1 & ASCE7-16 \S2.4.1 (LC 2)\\
LC 14 & 1.14D + 1.75E & ASCE7-16 \S2.4.5 (LC 8)\\
LC 15 & 1.1D + 1.31E + 0.75L0 & ASCE7-16 \S2.4.5 (LC 8)\\
LC 16 & 1.0D + 0.75L1 + 0.75L\textsubscriptr1 & ASCE7-16 \S2.4.1 (LC 4)\\
LC 17 & 1.0D + 0.75L0 & ASCE7-16 \S2.4.1 (LC 4)\\
LC 18 & 1.1D + 1.31E + 0.75L0 + 0.75L1 & ASCE7-16 \S2.4.5 (LC 8)\\
LC 19 & 1.0D & ASCE7-16 \S2.4.1 (LC 1)\\
LC 20 & 1.0D + 1.0L0 + 1.0L1 & ASCE7-16 \S2.4.1 (LC 2)\\
LC 21 & 1.1D + -1.31E + 0.75L1 & ASCE7-16 \S2.4.5 (LC 8)\\
LC 22 & 1.0D + 0.75L0 + 0.75L\textsubscriptr0 + 0.75L1 + 0.75L\textsubscriptr1 & ASCE7-16 \S2.4.1 (LC 4)\\
LC 23 & 1.0D + 1.0L0 & ASCE7-16 \S2.4.1 (LC 2)\\
LC 24 & 1.1D + -1.31E + 0.75L0 & ASCE7-16 \S2.4.5 (LC 8)\\
LC 25 & 0.6D & ASCE7-16 \S2.4.1 (LC 7)\\
LC 26 & 1.0L0 + 1.0L1 & L only deflection check\\
LC 27 & 0.4D + 1.75E & ASCE7-16 \S2.4.5 (LC 9)\\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test3/Test3_moment.pgf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test3/Test3_Cb.pgf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test3/Test3_shear.pgf}
\end{center}
...
\begin{flalign*}
\frac{h}{t_w} = \frac{8.8 {\color{darkBlue}{\mathbf{ \; in}}}}{0.19 {\color{darkBlue}{\mathbf{ \; in}}}} = \mathbf{46.57894736842105 } <= 2.24\sqrt{\frac{E}{F_y}} = 2.24\sqrt{\frac{29000 {\color{darkBlue}{\mathbf{ \; ksi}}}}{50 {\color{darkBlue}{\mathbf{ \; ksi}}}}} = \mathbf{53.9 } \rightarrow C_{v1} = \mathbf{1.0}
\end{flalign*}
\textphi\textsubscript{v}, the resistance factor for shear, is calculated per AISC/ANSI 360-16 {\S}G2.1.a as follows:
\begin{flalign*}
\frac{h}{t_w} = \frac{8.8 {\color{darkBlue}{\mathbf{ \; in}}}}{0.19 {\color{darkBlue}{\mathbf{ \; in}}}} = \mathbf{46.57894736842105 } <= 2.24\cdot \sqrt{\frac{E}{F_y}} = 2.24\cdot \sqrt{\frac{29000 {\color{darkBlue}{\mathbf{ \; ksi}}}}{50 {\color{darkBlue}{\mathbf{ \; ksi}}}}} = \mathbf{53.9} \rightarrow \phi_v = \mathbf{1.0}
\end{flalign*}
\textphi\textsubscript{v}V\textsubscript{n}, the design shear strength, is calculated per AISC/ANSI 360-16 Eq. G2-1 as follows:
\begin{flalign*}
\phi_v V_n = 0.6\cdot F_y \cdot A_w \cdot C_{v1}  = 0.6\cdot 50 {\color{darkBlue}{\mathbf{ \; ksi}}} \cdot 1.8753 {\color{darkBlue}{\mathbf{ \; {\color{darkBlue}{\mathbf{ \; in}}}^{2}}}} \cdot C_{v1}  = \mathbf{56.3 {\color{darkBlue}{\mathbf{ \; kip}}}}
\end{flalign*}
\vspace{-26pt}
{\setlength{\mathindent}{0cm}
\begin{flalign*}
...
\begin{figure}[H]
\begin{center}
\input{output_reports/test3/Test3_defl.pgf}
\end{center}
